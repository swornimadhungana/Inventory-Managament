...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
      <div class="container">
      <form method="post" action="../Function/addsupplier.php">
...
<div class="row">
  <label for="status" >Status:</label><select name="supplierstatus" id="status">
    <option value="active">Active</option>
    <option value="inactive">Inactive</option>
  </select>
</div>
<label for="button"></label><input type="submit" value="Add Supplier" id="button" required></div>
</div>
</form>
      </div>
      </div>
