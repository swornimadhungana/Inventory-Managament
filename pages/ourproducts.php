...
<html lang="en">
  ...
  <body>
    ...
    <i class="fa-solid fa-magnifying-glass searchbutton"></i></div>
<table>
  <thead>
    <tr>
      <th>SN</th>
...
<th>Actions</th>
 ...
 <i class="fa-solid fa-pen-to-square"></i> </a>
   ...
   if(isset($_SESSION['user'])){
    ...
    <a href="<?php echo '../Function/deleteitem.php?id=' . $row['Product_ID'] ?>" onclick="return confirm('Are you sure you want to delete?')"><i class="fa-solid fa-trash"></i></a>
    <?php
   }
   ?>
 </a>
