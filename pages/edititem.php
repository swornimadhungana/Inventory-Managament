...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/additems.css">
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
                ...
                ?>
                        <form method="post" action="../Function/edititem.php" class="additems" enctype="multipart/form-data">
                            <!--enct type le photo upload garauna help garxa-->
                            <label for="name">Product Name:</label><input type="text" placeholder="Product Name" id="name" required name="name" <?php echo "value='".$row['Product_Name']."'";?>>
                            
                            <!-- label le box mathi email lekheko dekhauxa -->
                            <label for="name1">Manufacturer's Name:</label><input type="text" placeholder="Manufacturer's Name" id="name1" required name="mname" <?php echo "value='".$row['Product_Mname']."'";?>>
                            
                            <div class="row"><label for="price" class="row1">Price:</label><input type="text" placeholder="Price" id="price" required name="price" <?php echo "value='".$row['Product_Price']."'";?>>
                            
                                <label for="weight" class="row1">Weight(g):</label><input type="text" placeholder="Weight" id="weight" required name="weight" <?php echo "value='".$row['Product_Weight']."'";?>>
                                
                                <label for="quantity" class="row1">Quantity:</label><input type="text" placeholder="Quantity" id="quantity" required name="quantity"  <?php echo "value='".$row['Product_Quantity']."'";?>>
                               
                            </div>
                            <label for="dom">Date Of Manufacturing:</label><input type="text" placeholder="Date Of Manufacturing" id="dom" required name="dom"  <?php echo "value='".$row['Product_Dom']."'";?>>
                            <label for="doe">Date Of Expiry:</label><input type="text" placeholder="Date Of Expiry" id="doe" required name="doe"  <?php echo "value='".$row['Product_Doe']."'";?>>
                            ...
                            <div class="category1"><select name="category" id="category">
                                ...
                                <label for="addphoto" class="photo">Add Photo: </label><input type="file" id="addphoto" name="productimage2" required>
                            </div>
                            <label for="button"></label><input type="submit" value="Edit" id="button" required>
                            <input type="hidden" name="id"   <?php echo "value='".$row['Product_ID']."'";?> >
